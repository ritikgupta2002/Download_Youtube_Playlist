...
# Specify the range of videos to download (e.g., videos 5 to 10)
playlist_range = ''  # This will download videos 5 to 10 from the playlist ex=14-35
...
ydl_opts = {
    ...
    'playlist_ranges': [playlist_range],  # Specify which range of videos to download
}
